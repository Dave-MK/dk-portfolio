          ...
          <FadeUp delay={0.1} className="order-1 lg:order-2">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-medium text-[#F4F7FB] transition-all hover:bg-white/10"
              >
                Connect on LinkedIn →
              </a>
              <Link
                href="/cv"
                className="inline-flex items-center gap-2 rounded-full border border-white/10 px-5 py-2.5 text-sm font-medium text-[#9BA7B7] transition-all hover:text-[#F4F7FB] hover:border-white/20"
              >
                View CV
              </Link>
            </div>
